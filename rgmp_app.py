...
def rgmp_app_layout(rgmp_app):
    ...
    html.Div([
        ...
        their organizational objectives. New investment portfolio that take ESG metrics into consideration are emerging,\
        ...
        and hence will want to rule out any outliers for their portfolio. An ESG score typically won't capture this.",style={'marginLeft':20,'marginRight':20}),
        ...
        the hierarchical dataset for specific metrics.", style={'marginLeft':20,'marginRight':20}),
